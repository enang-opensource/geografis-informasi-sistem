                    ...
                    <form class="forms-sample" action="backend/lokasi/edit.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="id_kategori">
                          <?php $query = $mysqli->query("SELECT * FROM tb_kategori WHERE id_kategori=2"); ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <label for="exampleFormControlSelect2">Jenis Sekolah</label>
                          <select class="form-control" name="jenis_lokasi">
                            <option value="SD" <?php if($data->jenis_lokasi=='SD'){ echo "selected"; }?>>SD</option>
                            <option value="SMP" <?php if($data->jenis_lokasi=='SMP'){ echo "selected"; }?>>SMP</option>
                            <option value="SMA" <?php if($data->jenis_lokasi=='SMA'){ echo "selected"; }?>>SMA</option>
                            <option value="TK" <?php if($data->jenis_lokasi=='TK'){ echo "selected"; }?>>TK</option>
                          </select>
                        </div>
                      </div>
